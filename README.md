...
- **S3 Website (Origin):**  
  👉 [View Link](http://divya-portoflio-website.s3-website.eu-north-1.amazonaws.com)
...
### 3️⃣ Amazon CloudFront Configuration
- Created a CloudFront distribution  
- Configured S3 as the origin  
- Enabled **Origin Access Control (OAC)**  
- Linked CloudFront securely with S3  
- Used CloudFront URL for global access  
